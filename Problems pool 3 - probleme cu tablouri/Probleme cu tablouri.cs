...
namespace Problems_pool_3___probleme_cu_tablouri
{
    class Program
    {
        public static int Crescator { get; private set; }
        ...
        private static void OperatiiCuMultimi2()
        {
            ...
            Console.WriteLine("Introduceti elementele vectorului v1 in ordine crescatoare");
            for (i = 0; i < n; i++)
            {
                v1[i] = int.Parse(Console.ReadLine());
            }
            Console.WriteLine("Introduceti elementele vectorului v2 in ordine crescatoare");
            for (j = 0; j < x; j++)
            {
        ...
        {
            int n, x, k = 0, j, i, gasit, z = 0, k1= 0, z1 = 0;
